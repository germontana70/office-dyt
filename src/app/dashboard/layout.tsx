        ...
        <html lang="es" className="dark">
            <body className={`${inter.className} min-h-screen antialiased`}>
                ...
                <div className="fixed inset-0 z-[-1] bg-background">
                    ...
                    <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-blue-900/30 blur-[150px]" />
                </div>
                ...
                <div className="flex min-h-screen">
                    ...
                    <aside className="hidden w-64 flex-col border-r border-white/10 bg-black/20 backdrop-blur-xl md:flex">
                        <div className="flex h-14 items-center border-b border-white/10 px-6">
                            <span className="font-bold tracking-tight bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">Office DYT</span>
                        </div>
                    ...
                    <main className="flex-1 flex flex-col">
                        <header className="flex h-14 items-center gap-4 border-b border-white/10 bg-black/10 backdrop-blur-md px-6">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-primary to-blue-400 ring-2 ring-background cursor-pointer hover:ring-primary transition-all" />
                            </div>
                        </header>
