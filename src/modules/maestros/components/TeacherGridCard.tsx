...
export function TeacherGridCard({ teacher }: { teacher: Teacher }) {
    return (
        <TeacherFormModal
            teacher={teacher}
            trigger={
                <GlassCard interactive className="h-full p-6 border-white/5 bg-black/30 dark:bg-black/40 backdrop-blur-xl group hover:border-accent/30 transition-all duration-500 overflow-hidden relative">
